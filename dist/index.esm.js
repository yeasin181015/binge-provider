...
function createBox(options = {}) {
  ...
  const Box = /*#__PURE__*/React.forwardRef(function Box(inProps, ref) {
    ...
    return /*#__PURE__*/jsx$1(BoxRoot, _extends$1({
      as: component,
      ref: ref,
...
function RtlProvider(_ref) {
  ...
  return /*#__PURE__*/jsx$1(RtlContext.Provider, _extends$1({
...
function ThemeProvider$1(props) {
  ...
  return /*#__PURE__*/jsx$1(ThemeProvider$2, {
    theme: privateTheme,
    children: /*#__PURE__*/jsx$1(ThemeContext$2.Provider, {
      value: engineTheme,
      children: /*#__PURE__*/jsx$1(RtlProvider, {
        value: rtlValue,
        children: /*#__PURE__*/jsx$1(DefaultPropsProvider, {
...
function createContainer(options = {}) {
  ...
  const Container = /*#__PURE__*/React.forwardRef(function Container(inProps, ref) {
    ...
    return (/*#__PURE__*/
      ...
      jsx$1(ContainerRoot, _extends$1({
        as: component
        // @ts-ignore module augmentation fails if custom breakpoints are used
        ,
...
function ThemeProvider(_ref) {
  ...
  return /*#__PURE__*/jsx$1(ThemeProvider$1, _extends$1({}, props, {
...
const TouchRipple = /*#__PURE__*/React.forwardRef(function TouchRipple(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(TouchRippleRoot, _extends$1({
...
const ButtonBase = /*#__PURE__*/React.forwardRef(function ButtonBase(inProps, ref) {
  ...
  return /*#__PURE__*/jsxs(ButtonBaseRoot, _extends$1({
    ...
    jsx$1(TouchRipple$1, _extends$1({
      ref: handleRippleRef,
      center: centerRipple
...
const Typography = /*#__PURE__*/React.forwardRef(function Typography(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(TypographyRoot, _extends$1({
    as: Component,
    ref: ref,
    ownerState: ownerState,
    className: clsx(classes.root, className)
...
const Banner = () => {
    ...
    return (jsxs(Box$1, { sx: { position: "relative" }, children: [jsx$1(Box$1, { sx: {
                    position: "relative",
                    display: "flex",
                    justifyContent: "end",
                    width: "100%",
                }, children: jsx$1("img", { src: imageSrc, alt: "hero", style: { width: "70%", maxWidth: "1003px", height: "auto" } }) }), jsx$1(Box$1, { sx: {
                    position: "absolute",
                    top: 0,
                    left: 0,
                    width: { xs: "100%", md: "80%" },
                    ...
                    background: {
                        ...
                        marginLeft: is1400px
                            ...
                            : isLg
                    ...
                    }, children: [jsxs(Typography$1, { variant: "h3", sx: {
                                ...
                                alignItems: "center",
                                gap: "8px",
                            }, children: [jsx$1(Box$1, { component: "img", src: BingeLogo, alt: "binge", sx: {
                                        width: is1400px
                                            ? 165
                                            : isLg
                                                ? 150
                                                : { xs: 80, sm: 100, md: 135 },
                                    } }), jsx$1("span", { children: "is an online video" })] }), jsx$1(Typography$1, { variant: "h3", sx: {
                                fontWeight: 700,
                                fontSize: is1400px
                                    ? "48px"
                                    : isLg
                                ...
                                alignItems: "center",
                                gap: "8px",
                            }, children: jsx$1("span", { style: {
                                    color: "#EEEFFC",
                                    marginTop: "0px",
                                    marginBottom: "0px",
                                }, children: "streaming platform" }) }), jsxs(Button$1, { sx: {
                                background: "#FF4A50",
                                borderRadius: "32px",
                                display: "flex",
                                justifyContent: "center",
                            ...
                            }, children: ["Watch Now", jsx$1(WatchIcon, {})] })] }) })] }));
};

const BingeLandingPage = () => {
    return (jsx$1(ThemeProvider, { theme: createTheme({ palette }), children: jsx$1(Box$1, { children: jsx$1(Banner, {}) }) }));
};
